                    ...
                    <div class="box box-primary">
                        ...
                        <table class="table">
                            ...
                            @foreach ($estudiantes as $item)
                                <form method="GET" action="{{ route('reject') }}">
                                    @csrf
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width:30%;">
                                                <button name="accion" value="aceptar" class="btn btn-primary" type="submit"><i class="fa fa-check"></i><i> Validar Usuario</i></button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </form>
